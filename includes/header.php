    ...
    <header class="bg-gray-800 text-white p-2 fixed w-full top-0 left-0 z-50 shadow-md">
        <div class="max-w-6xl mx-auto flex items-center justify-between">
            <h1 class="text-center text-xl">
                <a href="/" class="hover:bg-blue-700 p-2 rounded transition duration-300">NikkiApp V1.1</a>
            </h1>
            <nav class="space-x-4">
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <?php endif; ?>
                    <a href="/profile" class="text-white hover:bg-blue-700 p-2 rounded transition duration-300">Profile</a>
